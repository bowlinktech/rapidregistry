...
<div class="row-fluid">
      <div class="col-md-12">
          <section class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-right">
                    <a href="#importModal" data-toggle="modal" class="btn btn-primary btn-xs btn-action" id="createNewReport"  title="Add New Aggregated Report">Add New Aggregated Report</a>
                </div>
                                    ...
                                    <c:forEach var="report" items="${repList}">
                                        <tr>
                                            ...
                                            <td class="actions-col">
                                                <a href="aggregated-reports/details?r=${report.id}" class="btn btn-link editDetails" title="Edit this report">
