...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
        <ul class="nav nav-pills nav-stacked" role="menu">
            ...
            <li role="menuitem" ${param['page'] == 'users' ? 'class="active"' : ''} ${id > 0 ? '' : 'class="disabled"'}><a href="${param['page'] != 'users' && id > 0 ? 'program-admin-users' : 'javascript:void(0);'}" title="Program Admin Users">Program Admin Users</a></li>
        </ul>
    </nav>
</aside>