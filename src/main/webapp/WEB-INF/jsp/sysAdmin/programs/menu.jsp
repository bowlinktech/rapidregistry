...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
        <ul class="nav nav-pills nav-stacked" role="menu">
            ...
            <li role="menuitem" ${param['page'] == 'demodata' ? 'class="active"' : ''} ${id > 0 ? '' : 'class="disabled"'}><a href="${param['page'] != 'demodata' && id > 0 ? 'demo-data-elements' : 'javascript:void(0);'}" title="Demographic Data Elements">Patient Detail Sections</a></li>
            <li role="menuitem" ${param['page'] == 'healthdata' ? 'class="active"' : ''} ${id > 0 ? '' : 'class="disabled"'}><a href="${param['page'] != 'healthdata' && id > 0 ? 'health-data-elements' : 'javascript:void(0);'}" title="Health Data Elements">Engagement Sections</a></li>
