        ...
        <div class="col-md-12">
            <section class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">MPI Algorithms</h3>
                </div>
                <div class="panel-body">
                    <div class="form-container scrollable"><br />
                        <table class="table table-striped table-hover table-default" <c:if test="${not empty mpiAlgorithms}">id="dataTable"</c:if>>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                <c:choose>
                                    <c:when test="${not empty mpiAlgorithms}">
                                        <c:forEach var="algorithm" items="${mpiAlgorithms}">
                                            <tr>
                                                <td>
                                    ...
                                    <c:otherwise>
                                        <tr><td colspan="7" class="center-text">There are currently no MPI Algorithms set up.</td></tr>
                                    </c:otherwise>
                                </c:choose>
                            </tbody>
                        </table>
...
<div class="modal fade" id="algorithmDetailsModal" role="dialog" tabindex="-1" aria-labeledby="Add MPI Algorithm" aria-hidden="true" aria-describedby="Add MPI Algorithm"></div>
