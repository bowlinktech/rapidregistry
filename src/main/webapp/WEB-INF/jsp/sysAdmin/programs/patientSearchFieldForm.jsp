        ...
        <div class="modal-body">
            <c:choose>
                <c:when test="${availablePatientFields.size() > 0}">
                    <form:form id="searchField" commandName="programPatientSearchFields"  method="post" role="form">
                        <input type="hidden" id="action" name="action" value="save" />
                        <input type="hidden" id="progamNameURL" value="${programName}" />
                        <input type="hidden" name="currdspPos" value="${programPatientSearchFields.dspPos}" />
                        ...
                        <div class="form-group">
                            <input type="button" id="submitSearchButton" role="button" class="btn btn-primary" value="Save"/>
                        </div>
                    </form:form>
                </c:when>
                <c:otherwise>
