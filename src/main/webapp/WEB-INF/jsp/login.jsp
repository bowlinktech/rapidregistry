        ...
        <form role="form" id="form-admin-login" name='f' action="<c:url value='j_spring_security_check' />" method='POST'>
            ...
            <fieldset name="login-fields" form="form-admin-login" class="basic-clearfix">
                <div class="form-group ${not empty error ? 'has-error' : '' }">
                    ...
                    <input id="username" name='j_username' class="form-control" type="text" value="missouri@gmail.com" autofocus="true" autocomplete="off" />
                </div>
                <div class="form-group ${not empty error ? 'has-error' : '' }">
                    <label class="control-label" for="password">Password</label>
                    <input id="password" name='j_password' class="form-control" type="password" value="missouri" autocomplete="off" />
                </div>
