            ...
            <div class="tab-pane tab-pane-question fade active in editPane" id="edit">
                ...
                <div class="well well-xsm" style="background-color:#ffffff;">
                    <div class="row">
                        ...
                        <div class="col-md-5 ">
                            <form:radiobutton path="dateType" id="dateType" value="1" />&nbsp;Single Date
                            <form:radiobutton path="dateType" id="dateType" value="2" style="margin-left:10px;" />&nbsp;Date Range
                            <form:radiobutton path="dateType" id="dateType" value="3" style="margin-left:10px;" />&nbsp;Time Only
                         </div>
                        <div class="col-md-5">
                 ...
                 <div class="well well-xsm" id="collectTime" style="${surveyQuestion.dateType != 3 ? 'display:block;' : 'display:none;'} background-color:#ffffff;">
                    <div class="row">
                        <div class="col-md-2" style="width:200px;">
                            <label class="control-label">Do you want to collect time?:</label>
                        </div>
                        <div class="col-md-5 ">
                            <form:radiobutton path="includeTime" id="includeTime" value="1" />&nbsp;Yes
                            <form:radiobutton path="includeTime" id="includeTime" value="0" style="margin-left:10px;" />&nbsp;No
                         </div>
                    </div>
                </div>       
            </div>
