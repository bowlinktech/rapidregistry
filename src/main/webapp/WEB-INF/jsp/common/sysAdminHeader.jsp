        ...
        <div class="contain">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav" role="menu">
                    ...
                    <li role="menuitem" class="${param['sect'] == 'adminFns' ? 'active' : 'none'}"><a href="<c:url value='/sysAdmin/adminFns/loginas' />" title="Admin Functions">Admin Functions</a><c:if test="${param['sect'] == 'adminFns'}"><span class="indicator-active arrow-up"></span></c:if></li>
                </ul>
