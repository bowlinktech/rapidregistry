        ...
        <div class="contain">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav" role="menu">
                    ...
                    <li role="menuitem" class="${param['sect'] == 'activitycodes' ? 'active' : 'none'}"><a href="<c:url value='/sysAdmin/activity-codes/list' />" title="Activity Code Manager">Activity Code Manager</a><c:if test="${param['sect'] == 'activitycodes'}"><span class="indicator-active arrow-up"></span></c:if></li>
