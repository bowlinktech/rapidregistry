        ...
        <div class="contain">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav" role="menu">
                    ...
                    <li role="menuitem" class="${param['sect'] == 'dataelements' ? 'active' : 'none'}"><a href="<c:url value='/sysAdmin/data-elements/' />" title="Data Element Manager">Data Element Manager</a><c:if test="${param['sect'] == 'dataelements'}"><span class="indicator-active arrow-up"></span></c:if></li>
